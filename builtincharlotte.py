...
LISTING_URL = "https://www.builtincharlotte.com/articles"
SOURCE_NAME = "BUILTIN_CHARLOTTE"
SCRAPER_ID = 88
...
def parse_listing_items(html):
    ...
    for container in soup.select("div.border-top.border-gray-02"):
        ...
        if not article_url.startswith("http"):
            article_url = "https://www.builtincharlotte.com" + article_url
...
async def async_main():
    print("🔍 Fetching Built In Charlotte articles...")
