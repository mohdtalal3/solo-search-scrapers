...
NEWS_PAGE_URL = "https://www.consultancy.eu/news"
SOURCE_NAME = "CONSULTANCY_EU"
SCRAPER_ID = 15
...
def get_article_links():
    ...
    for a in soup.select(".news-grid .news-item-info > a"):
        ...
        if href.startswith("http"):
            ...
            links.append("https://www.consultancy.eu" + href)
...
# ----------------------------------------------------------
def main():
    print("🔍 Fetching consultancy.eu news page...")
