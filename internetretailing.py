...
API_URL = "https://internetretailing.net/wp-json/wp/v2/posts"
SOURCE_NAME = "INTERNET_RETAILING"
...
def fetch_posts_with_retry(page_num, max_retries=3):
    """Fetch posts from the WP API via Scrappey."""
...
def main():
    if not is_subscription_active(SCRAPER_ID, COMPANY_ID):
        print("⏭️  Skipping Internet Retailing — subscription is inactive")
        return
    ...
    print("🔍 Fetching articles from Internet Retailing API...")
